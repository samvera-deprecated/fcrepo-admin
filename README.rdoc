...
* Add abilities to your Ability class
  ...
  Note that FcrepoAdmin::DatastreamAbility currently uses the #custom_permissions hook provided by Hydra::Ability. 
  This will likely change in the future to prevent conflicts with custom permissions in the application.
