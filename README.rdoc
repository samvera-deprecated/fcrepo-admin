...
Beginning with fcrepo_admin 0.5.0 (unreleased), the preferred method of customizing the object and datastream context navs
involves configuration settings and (optionally) overriding new helper methods for custom nav items.  Details will be added here
at release time.
